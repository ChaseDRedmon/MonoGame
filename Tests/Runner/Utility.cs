...
{
    static public ByteComparer Equal = new();
...
{
    static public ColorComparer Equal = new();
...
{
    static public FloatComparer Epsilon = new(0.000001f);
...
{
    static public BoundingSphereComparer Epsilon = new(0.000001f);
...
{
    static public Vector2Comparer Epsilon = new(0.000001f);
...
{
    static public Vector3Comparer Epsilon = new(0.000001f);
...
{
    static public Vector4Comparer Epsilon = new(0.000001f);
...
{
    static public QuaternionComparer Epsilon = new(0.000001f);
...
{
    static public PlaneComparer Epsilon = new(0.000001f);
