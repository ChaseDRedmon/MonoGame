...
public class MathHelperTest
{
    ...
    public void LerpTest()
    {
        ...
        Assert.AreEqual(MathHelper.Lerp(10000000000000000f, 1f, 1f), 0f,
            "Lerp test failed on [10000000000000000,1,1]");
    }
    ...
    public void LerpPreciseTest()
    {
        ...
        Assert.AreEqual(MathHelper.LerpPrecise(10000000000000000f, 1f, 1f), 1,
            "LerpPrecise test failed on [10000000000000000,1,1]");
    }
#endif
