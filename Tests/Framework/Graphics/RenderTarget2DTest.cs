...
class RenderTarget2DTest : GraphicsDeviceTestFixtureBase
{
    ...
    public void PreferredSurfaceFormatTest(SurfaceFormat preferredSurfaceFormat,
        SurfaceFormat expectedSurfaceFormat)
    {
    ...
    public void GetDataMSAA()
    {
        ...
        var rt = new RenderTarget2D(gd, size, size, false, SurfaceFormat.Color, DepthFormat.None, 8,
            RenderTargetUsage.DiscardContents);
    ...
    {
        var rt = new RenderTarget2D(gd, 16, 16, false, SurfaceFormat.Color, DepthFormat.None,
            preferredMultiSampleCount, RenderTargetUsage.PlatformContents, true);
