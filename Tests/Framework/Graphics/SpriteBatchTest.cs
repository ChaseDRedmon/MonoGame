...
class SpriteBatchTest : GraphicsDeviceTestFixtureBase
{
    ...
    public void Draw_with_SpriteSortMode(SpriteSortMode sortMode)
    {
        ...
        _spriteBatch.Draw(_texture, new Vector2(110, 110), null, Color.White, 0.0f, Vector2.Zero, 1.0f,
            SpriteEffects.None, 1.0f);
        _spriteBatch.Draw(_texture2, new Vector2(130, 130), null, Color.White, 0.0f, Vector2.Zero, 1.0f,
            SpriteEffects.None, 0.2f);
        _spriteBatch.Draw(_texture3, new Vector2(145, 145), null, Color.White, 0.0f, Vector2.Zero, 1.0f,
            SpriteEffects.None, 0.3f);
        _spriteBatch.Draw(_texture, new Vector2(160, 160), null, Color.White, 0.0f, Vector2.Zero, 1.0f,
            SpriteEffects.None, 0.5f);
        _spriteBatch.Draw(_texture3, new Vector2(205, 205), null, Color.White, 0.0f, Vector2.Zero, 1.0f,
            SpriteEffects.None, 0f);
        _spriteBatch.Draw(_texture2, new Vector2(190, 190), null, Color.White, 0.0f, Vector2.Zero, 1.0f,
    ...
    public void Draw_with_viewport_changing(SpriteSortMode sortMode)
    {
        ...
        _effect.Projection = halfPixelOffset *
                             Matrix4x4.CreateOrthographicOffCenter(0, gd.Viewport.Width, gd.Viewport.Height, 0, 0, 1);
