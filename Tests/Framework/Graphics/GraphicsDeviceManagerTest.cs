...
internal class GraphicsDeviceManagerTest
{
    ...
    public void PreparingDeviceSettingsArgsPresentationParametersAreApplied()
    {
        ...
        game.PreInitializeWith += (sender, args) =>
        {
            ...
            {
                a.GraphicsDeviceInformation.GraphicsProfile = GraphicsProfile.HiDef;
                a.GraphicsDeviceInformation.PresentationParameters.RenderTargetUsage =
        ...
        Assert.That(invoked);
        Assert.AreEqual(RenderTargetUsage.PreserveContents,
            gdm.GraphicsDevice.PresentationParameters.RenderTargetUsage);
    ...
    public void ApplyChangesReturnsWhenNoSetterCalled()
    {
        ...
        game.PreInitializeWith += (sender, args) =>
        {
            gdm.PreparingDeviceSettings += (s, a) => { invoked = true; };
        };
    ...
    public void ApplyChangesInvokesPreparingDeviceSettings()
    {
        ...
        game.InitializeWith += (sender, args) => { gdm.PreparingDeviceSettings += (s, a) => { invoked = true; }; };
...
internal class GraphicsDeviceManagerFixtureTest : GraphicsDeviceTestFixtureBase
{
    ...
    public void ResettingDeviceTriggersResetEvents()
    {
        ...
        gdm.DeviceResetting += (sender, args) => { resettingCount++; };
    ...
    public void NewDeviceDoesNotTriggerReset()
    {
        ...
        gd.DeviceReset += (sender, args) => { resetCount++; };
        gd.DeviceLost += (sender, args) => { devLostCount++; };
    ...
    {
        var count = 0;
        game.Window.ClientSizeChanged += (sender, args) => { count++; };
        gdm.GraphicsProfile = GraphicsProfile.HiDef;
        gdm.ApplyChanges();
    ...
    public void MSAAEnabled(bool enabled)
    {
        ...
        spriteBatch.Begin();
        spriteBatch.Draw(tex, new Vector2(800 / 2, 480 / 2), null, Color.White, MathHelper.ToRadians(45),
            new Vector2(0.5f), 200, SpriteEffects.None, 0);
        spriteBatch.End();
