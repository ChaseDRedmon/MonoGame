...
class VertexBufferTest : GraphicsDeviceTestFixtureBase
{
    ...
    {
        new(new Vector3(1, 2, 3), new Vector2(0.1f, 0.2f)),
        new(new Vector3(4, 5, 6), new Vector2(0.3f, 0.4f)),
        new(new Vector3(7, 8, 9), new Vector2(0.5f, 0.6f)),
        new(new Vector3(10, 11, 12), new Vector2(0.7f, 0.8f))
    };

    VertexPositionTexture vertexZero = new(Vector3.Zero, Vector2.Zero);
    ...
    public void SetDataWithElementCount(bool dynamic, int startIndex, int elementCount, bool shouldSucceed,
...
#endif
    public void SetDataWithElementCountAndVertexStride(bool dynamic, int elementCount, int vertexStride,
        Type expectedExceptionType)
    {
        var vertexBuffer = dynamic
            ? new DynamicVertexBuffer(gd, typeof(VertexPositionTexture), savedData.Length,
    ...
    public void SetDataStructWithElementCountAndVertexStride(bool dynamic, int elementCount, int vertexStride,
        bool shouldSucceed, Type expectedExceptionType)
    {
        var vertexBuffer = dynamic
            ? new DynamicVertexBuffer(gd, typeof(VertexPositionTexture), savedData.Length,
                BufferUsage.None)
