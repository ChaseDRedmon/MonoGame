        ...
        Action<int> action = frameNr =>
        {
            ...
            switch (state)
            {
                case 0:
                    ...
                    occlusionQuery.Begin();
                    spriteBatch.Begin(SpriteSortMode.Immediate, null, null, DepthStencilState.Default, null);
                    spriteBatch.Draw(whiteTexture, new Rectangle(50, 100, 100, 100), null, Color.Red, 0,
                        Vector2.Zero,
                ...
                case 2:
                    ...
                    occlusionQuery.Begin();
                    spriteBatch.Begin(SpriteSortMode.Immediate, null, null, DepthStencilState.Default, null);
                    spriteBatch.Draw(whiteTexture, new Rectangle(10, 100, 100, 100), null, Color.Red, 0,
                        Vector2.Zero,
                        SpriteEffects.None, 1);
                    spriteBatch.End();
                    occlusionQuery.End();
