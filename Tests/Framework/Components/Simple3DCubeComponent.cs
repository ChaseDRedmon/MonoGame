...
class Simple3DCubeComponent
{
    ...
    public void LoadContent()
    {
        ...
        viewMatrix = Matrix4x4.CreateLookAt(new Vector3(0, 0, 5), Vector3.Zero, Vector3Helper.Up);
        projectionMatrix =
            Matrix4x4.CreatePerspectiveFieldOfView(MathHelper.PiOver4, graphicsDevice.Viewport.AspectRatio, 1, 10);
    ...
    public void Draw()
    {
        ...
        foreach (EffectPass pass in basicEffect.CurrentTechnique.Passes)
        {
            ...
            graphicsDevice.DrawIndexedPrimitives(PrimitiveType.TriangleList, 0, 0, number_of_vertices, 0,
                number_of_indices / 3);
        }
    }
    ...
    void CreateCubeVertexBuffer()
    {
        ...
        vertices = new VertexBuffer(graphicsDevice, VertexPositionTexture.VertexDeclaration, number_of_vertices,
