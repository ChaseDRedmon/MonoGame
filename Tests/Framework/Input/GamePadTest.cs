...
public class GamePadTest
{
    ...
    public void GamePadButtonsTest(params Buttons[] buttons)
    {
        ...
        Assert.AreEqual(buttons.Contains(Buttons.LeftShoulder) ? ButtonState.Pressed : ButtonState.Released,
            gpb.LeftShoulder);
        Assert.AreEqual(buttons.Contains(Buttons.LeftStick) ? ButtonState.Pressed : ButtonState.Released,
            gpb.LeftStick);
        Assert.AreEqual(buttons.Contains(Buttons.RightShoulder) ? ButtonState.Pressed : ButtonState.Released,
            gpb.RightShoulder);
        Assert.AreEqual(buttons.Contains(Buttons.RightStick) ? ButtonState.Pressed : ButtonState.Released,
            gpb.RightStick);
        Assert.AreEqual(buttons.Contains(Buttons.BigButton) ? ButtonState.Pressed : ButtonState.Released,
            gpb.BigButton);
    }
#endif
    ...
    public void ThumbStickVirtualButtonsIgnoreDeadZone(Vector2 left, Vector2 right, GamePadDeadZone deadZone,
        Buttons expectedButtons)
    {
        var state = new GamePadState(new GamePadThumbSticks(left, right, deadZone, deadZone), new GamePadTriggers(),
    ...
    private static IEnumerable<TestCaseData> ThumbStickVirtualButtonsIgnoreDeadZoneTestCases
    {
        get
        {
            ...
            yield return new TestCaseData(
                ...
                Buttons.LeftThumbstickRight | Buttons.LeftThumbstickDown | Buttons.RightThumbstickLeft |
    ...
    public void PublicConstructorClampsValues(Vector2 left, Vector2 right, Vector2 expectedLeft,
    ...
    [TestCase((Buttons)0,
        new[] { ButtonState.Released, ButtonState.Released, ButtonState.Released, ButtonState.Released })]
    [TestCase(Buttons.DPadDown,
        new[] { ButtonState.Pressed, ButtonState.Released, ButtonState.Released, ButtonState.Released })]
    [TestCase(Buttons.DPadLeft,
        new[] { ButtonState.Released, ButtonState.Pressed, ButtonState.Released, ButtonState.Released })]
    [TestCase(Buttons.DPadRight,
        new[] { ButtonState.Released, ButtonState.Released, ButtonState.Pressed, ButtonState.Released })]
    [TestCase(Buttons.DPadUp,
        new[] { ButtonState.Released, ButtonState.Released, ButtonState.Released, ButtonState.Pressed })]
    ...
    {
        var state = new GamePadState(Vector2.Zero, Vector2.Zero, 0f, 0f,
            button != 0 ? new Buttons[] { button } : new Buttons[] { });
    ...
    public static IEnumerable<Buttons[]> GetButtons()
    {
        return new[]
        {
            ...
            new[]
            {
                Buttons.Back, Buttons.BigButton, Buttons.LeftStick, Buttons.Y, Buttons.B, Buttons.RightShoulder,
                Buttons.LeftTrigger
            },
            new[]
            {
                Buttons.RightTrigger, Buttons.RightStick, Buttons.RightShoulder, Buttons.DPadDown, Buttons.DPadLeft
            },
