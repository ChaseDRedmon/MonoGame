...
class DynamicSoundEffectInstanceTest
{
    ...
    public void Ctor()
    {
        ...
        {
            instance = new DynamicSoundEffectInstance(7999, AudioChannels.Stereo);
        });
        if (instance != null) instance.Dispose();
        Assert.Throws<ArgumentOutOfRangeException>(() =>
        {
            instance = new DynamicSoundEffectInstance(48001, AudioChannels.Stereo);
        });
        if (instance != null) instance.Dispose();
        ...
        Assert.Throws<ArgumentOutOfRangeException>(() =>
        {
            instance = new DynamicSoundEffectInstance(44100, (AudioChannels)123);
        });
        if (instance != null) instance.Dispose();
    }
    ...
    public void GetSampleSizeInBytes()
    {
        ...
        Assert.Throws<ArgumentOutOfRangeException>(() =>
        {
            monoInstance.GetSampleSizeInBytes(TimeSpan.FromSeconds(-1));
        });
    ...
    public void SubmitBuffer_ParameterValidation_ComplexOverload()
    {
        using (var instance = new DynamicSoundEffectInstance(16000, AudioChannels.Stereo))
        {
            ...
            {
                instance.SubmitBuffer(buffer, 1, 4);
