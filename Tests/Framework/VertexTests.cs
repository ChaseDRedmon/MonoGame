...
public class VertexTests
{
    ...
    public void TestVertexPositionColor()
    {
        ...
        var vertex4 = new VertexPositionColor(Vector3Helper.Forward, Color.Blue);
    ...
    public void TestVertexPositionColorTexture()
    {
        ...
        var vertex4 = new VertexPositionColorTexture(Vector3Helper.Forward, Color.Blue, Vector2.One);
        var vertex5 = new VertexPositionColorTexture(Vector3Helper.Forward, Color.Blue, Vector2.Zero);
    ...
    public void TestVertexPositionNormalTexture()
    {
        ...
        var vertex1 = new VertexPositionNormalTexture(Vector3.One, Vector3Helper.Forward, Vector2.One);
        var vertex2 = new VertexPositionNormalTexture(Vector3.One, Vector3Helper.Forward, Vector2.One);
        var vertex3 = new VertexPositionNormalTexture(Vector3.One, Vector3Helper.Backward, Vector2.One);
        var vertex4 = new VertexPositionNormalTexture(Vector3Helper.Forward, Vector3Helper.Backward, Vector2.One);
        var vertex5 = new VertexPositionNormalTexture(Vector3Helper.Forward, Vector3Helper.Backward, Vector2.Zero);
