...
class Bounding
{
    ...
    public void BoundingSphereTests()
    {
        ...
        var threePoint = BoundingSphere.CreateFromPoints(new[]
            { new Vector3(0, 0, 0), new Vector3(-1, 0, 0), new Vector3(1, 1, 1) });
        Assert.That(new BoundingSphere(new Vector3(0, 0.5f, 0.5f), 1.224745f),
            Is.EqualTo(threePoint).Using(BoundingSphereComparer.Epsilon));

        var eightPointTestInput = new Vector3[]
        {
            new(54.58071f, 124.9063f, 56.0016f),
            new(54.52138f, 124.9063f, 56.13985f),
            new(54.52208f, 124.8235f, 56.14014f),
            new(54.5814f, 124.8235f, 56.0019f),
            new(1145.415f, 505.913f, -212.5173f),
            new(611.4731f, 505.9535f, 1031.893f),
            new(617.7462f, -239.7422f, 1034.584f),
            new(1151.687f, -239.7035f, -209.8246f)
        };
    ...
    {
        var view = Matrix4x4.CreateLookAt(new Vector3(0, 0, 5), Vector3.Zero, Vector3Helper.Up);
    ...
    public void BoundingFrustumToBoundingFrustumTests()
    {
        ...
        var view2 = Matrix4x4.CreateLookAt(new Vector3(0, 0, 4), Vector3.Zero, Vector3Helper.Up);
        ...
        var view3 = Matrix4x4.CreateLookAt(new Vector3(0, 0, 6), new Vector3(0, 0, 7), Vector3Helper.Up);
        ...
        var view4 = Matrix4x4.CreateLookAt(new Vector3(0, 0, 10), Vector3.Zero, Vector3Helper.Up);
        ...
        var bf =
            new BoundingFrustum(Matrix4x4.CreateLookAt(new Vector3(0, 1, 1), new Vector3(0, 0, 0), Vector3Helper.Up) *
