...
static partial class GameTest
{
    ...
    public class Misc
    {
        ...
        private class CountCallsGame : Game
        {
            ...
            public void PublicUnloadContent()
            {
                UnloadContent();
            }
            ...
            public void PublicUpdate(GameTime gt = null)
            {
                Update(gt ?? new GameTime());
            }
            ...
            public void PublicDraw(GameTime gt)
            {
                Draw(gt ?? new GameTime());
            }
    ...
    private class RunLoopLogger : DrawableGameComponent
    {
        ...
        public struct Entry
        {
            ...
            public override string ToString()
            {
                ...
                switch (Action)
                {
                    case RunLoopAction.Draw:
                        actionInitial = 'd';
                        break;
                    case RunLoopAction.Update:
                        actionInitial = 'u';
                        break;
