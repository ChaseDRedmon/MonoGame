...
class PackedVectorTest
{
    ...
    public void Rgba64()
    {
        ...
        //Test data ordering
        Assert.AreEqual(0xC7AD8F5C570A1EB8,
            new Rgba64((float)0x1EB8 / 0xffff, (float)0x570A / 0xffff, (float)0x8F5C / 0xffff,
                (float)0xC7AD / 0xffff).PackedValue);
    ...
    public void NormalizedByte2()
    {
        ...
        Assert.AreEqual(new Vector4(1, 1, 0, 1), new NormalizedByte2(Vector2.One).ToVector4());
        Assert.AreEqual(new Vector4(0, 0, 0, 1), new NormalizedByte2(Vector2.Zero).ToVector4());
    ...
    public void NormalizedShort2()
    {
        ...
        Assert.AreEqual(new Vector4(1, 1, 0, 1), new NormalizedShort2(Vector2.One).ToVector4());
        Assert.AreEqual(new Vector4(0, 0, 0, 1), new NormalizedShort2(Vector2.Zero).ToVector4());
    ...
    public void Short2()
    {
        ...
        // Test ToVector4.
        Assert.AreEqual(new Vector4(0x7FFF, 0x7FFF, 0, 1),
            new Short2(Vector2.One * 0x7FFF).ToVector4());
        Assert.AreEqual(new Vector4(0, 0, 0, 1), new Short2(Vector2.Zero).ToVector4());
        Assert.AreEqual(new Vector4(-0x8000, -0x8000, 0, 1),
            new Short2(Vector2.One * -0x8000).ToVector4());
