        ...
        float rotation, Vector2 origin, Vector2 scale, SpriteEffects effects, float layerDepth)
    {
        ...
        else
        {
            ...
            transformation.M41 =
                ...
                (flipAdjustment.Y - origin.Y) * transformation.M21 + position.X;
            transformation.M42 =
                (flipAdjustment.X - origin.X) * transformation.M12 +
                (flipAdjustment.Y - origin.Y) * transformation.M22 + position.Y;
        }
            ...
            for (var i = 0; i < text.Length; ++i)
            {
                ...
                else
                {
                    offset.X += spriteFont.Spacing +
                                (rtl ? pCurrentGlyph->RightSideBearing : pCurrentGlyph->LeftSideBearing);
                }
