...
public partial class Texture3D : Texture
{
    ...
    public Texture3D(GraphicsDevice graphicsDevice, int width, int height, int depth, bool mipMap,
        SurfaceFormat format)
        : this(graphicsDevice, width, height, depth, mipMap, format, false)
    {
    }

    protected Texture3D(GraphicsDevice graphicsDevice, int width, int height, int depth, bool mipMap,
        ...
        T[] data, int startIndex, int elementCount) where T : struct
    {
        ...
        PlatformSetData(level, left, top, right, bottom, front, back, data, startIndex, elementCount, width, height,
            depth);
    }
