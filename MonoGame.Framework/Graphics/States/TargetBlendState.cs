...
public class TargetBlendState
{
    ...
    private static SharpDX.Direct3D11.BlendOperation GetBlendOperation(BlendFunction blend)
    {
        switch (blend)
        {
    ...
    private static SharpDX.Direct3D11.BlendOption GetBlendOption(Blend blend, bool alpha)
    {
        switch (blend)
        {
    ...
    private static SharpDX.Direct3D11.ColorWriteMaskFlags GetColorWriteMask(ColorWriteChannels mask)
    {
