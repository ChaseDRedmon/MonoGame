...
namespace Microsoft.Xna.Framework.Content
{
    public partial class ContentManager : IDisposable
    {
        ...
        private ContentReader GetContentReaderFromXnb(string originalAssetName, Stream stream, BinaryReader xnbReader,
        ...
        protected virtual void ReloadGraphicsAssets()
        {
            foreach (var asset in LoadedAssets)
            {
                ...
                genericMethod.Invoke(this,
                    new object[] { asset.Key, Convert.ChangeType(asset.Value, asset.Value.GetType()) });
            }
        }
