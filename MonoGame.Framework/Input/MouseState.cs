...
public struct MouseState
{
    ...
    {
        get { return (_buttons & LeftButtonFlag) > 0 ? ButtonState.Pressed : ButtonState.Released; }
        internal set
        {
    ...
    {
        get { return (_buttons & MiddleButtonFlag) > 0 ? ButtonState.Pressed : ButtonState.Released; }
        internal set
        {
            if (value == ButtonState.Pressed)
            {
    ...
    {
        get { return (_buttons & RightButtonFlag) > 0 ? ButtonState.Pressed : ButtonState.Released; }
        internal set
        {
            if (value == ButtonState.Pressed)
            {
    ...
    {
        get { return (_buttons & XButton1Flag) > 0 ? ButtonState.Pressed : ButtonState.Released; }
        internal set
        {
            if (value == ButtonState.Pressed)
            {
    ...
    {
        get { return (_buttons & XButton2Flag) > 0 ? ButtonState.Pressed : ButtonState.Released; }
        internal set
        {
            if (value == ButtonState.Pressed)
            {
