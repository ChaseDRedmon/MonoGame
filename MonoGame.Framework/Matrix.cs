...
public struct Matrix : IEquatable<Matrix>
{
    ...
    public bool Equals(Matrix other)
    {
        return M11 == other.M11 && M22 == other.M22 &&
               M33 == other.M33 && M44 == other.M44 &&
               M12 == other.M12 && M13 == other.M13 &&
               M14 == other.M14 && M21 == other.M21 &&
               M23 == other.M23 && M24 == other.M24 &&
               M31 == other.M31 && M32 == other.M32 &&
               M34 == other.M34 && M41 == other.M41 && M42 == other.M42 &&
               M43 == other.M43;
    }
    ...
    public override int GetHashCode()
    {
        return M11.GetHashCode() + M12.GetHashCode() + M13.GetHashCode() +
               ...
               M32.GetHashCode() +
               M33.GetHashCode() + M34.GetHashCode() + M41.GetHashCode() +
               M42.GetHashCode() +
    ...
    public static void Invert(ref Matrix matrix, out Matrix result)
    {
        ...
        float num23 = (float)(num6 * (double)num17 - num7 * (double)num18 +
                              num8 * (double)num19);
        float num24 = (float)-(num5 * (double)num17 - num7 * (double)num20 +
                               num8 * (double)num21);
        float num25 = (float)(num5 * (double)num18 - num6 * (double)num20 +
                              num8 * (double)num22);
        float num26 = (float)-(num5 * (double)num19 - num6 * (double)num21 +
                               num7 * (double)num22);
        float num27 = (float)(1.0 / (num1 * (double)num23 + num2 * (double)num24 +
                                     num3 * (double)num25 + num4 * (double)num26));
        ...
        result.M12 =
            (float)-(num2 * (double)num17 - num3 * (double)num18 + num4 * (double)num19) *
            num27;
        result.M22 =
            (float)(num1 * (double)num17 - num3 * (double)num20 + num4 * (double)num21) *
            num27;
        result.M32 =
            (float)-(num1 * (double)num18 - num2 * (double)num20 + num4 * (double)num22) *
            num27;
        result.M42 =
            (float)(num1 * (double)num19 - num2 * (double)num21 + num3 * (double)num22) *
            num27;
        ...
        result.M13 =
            (float)(num2 * (double)num28 - num3 * (double)num29 + num4 * (double)num30) *
            num27;
        result.M23 =
            (float)-(num1 * (double)num28 - num3 * (double)num31 + num4 * (double)num32) *
            num27;
        result.M33 =
            (float)(num1 * (double)num29 - num2 * (double)num31 + num4 * (double)num33) *
            num27;
        result.M43 =
            (float)-(num1 * (double)num30 - num2 * (double)num32 + num3 * (double)num33) *
            num27;
        ...
        result.M14 =
            (float)-(num2 * (double)num34 - num3 * (double)num35 + num4 * (double)num36) *
            num27;
        result.M24 =
            (float)(num1 * (double)num34 - num3 * (double)num37 + num4 * (double)num38) *
            num27;
        result.M34 =
            (float)-(num1 * (double)num35 - num2 * (double)num37 + num4 * (double)num39) *
            num27;
        result.M44 =
            (float)(num1 * (double)num36 - num2 * (double)num38 + num3 * (double)num39) *
            num27;
