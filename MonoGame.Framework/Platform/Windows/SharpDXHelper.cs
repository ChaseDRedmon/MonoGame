...
{
    public static SharpDX.DXGI.SwapEffect ToSwapEffect(PresentInterval presentInterval)
    {
    ...
    public static SharpDX.DXGI.Format ToFormat(DepthFormat format)
    {
        switch (format)
        {
            default:
    ...
    public static SharpDX.DXGI.Format ToFormat(SurfaceFormat format)
    {
        switch (format)
        {
    ...
    public static RawVector2 ToVector2(this Vector2 vec)
    {
        return new RawVector2(vec.X, vec.Y);
    }

    public static RawVector3 ToVector3(this Vector3 vec)
    {
        return new RawVector3(vec.X, vec.Y, vec.Z);
    }

    public static RawVector4 ToVector4(this Vector4 vec)
    {
    ...
    public static SharpDX.Direct3D11.Comparison ToComparison(this CompareFunction compare)
    {
        switch (compare)
        {
