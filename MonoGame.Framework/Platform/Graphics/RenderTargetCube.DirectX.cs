...
public partial class RenderTargetCube
{
    ...
    private void PlatformConstruct(GraphicsDevice graphicsDevice, bool mipMap, DepthFormat preferredDepthFormat,
        int preferredMultiSampleCount, RenderTargetUsage usage)
    {
        ...
        for (int i = 0; i < _renderTargetViews.Length; i++)
        {
            ...
            _renderTargetViews[i] =
                new RenderTargetView(graphicsDevice._d3dDevice, GetTexture(), renderTargetViewDescription);
        }
        ...
        using (var depthBuffer =
               new SharpDX.Direct3D11.Texture2D(graphicsDevice._d3dDevice, depthStencilDescription))
        {
            ...
            _depthStencilView =
                new DepthStencilView(graphicsDevice._d3dDevice, depthBuffer, depthStencilViewDescription);
        }
    }
