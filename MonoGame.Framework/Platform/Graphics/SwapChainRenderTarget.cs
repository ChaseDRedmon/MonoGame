...
public class SwapChainRenderTarget : RenderTarget2D
{
    ...
    private SharpDX.Direct3D11.Texture2D CreateSwaipChainTexture(Format dxgiFormat,
    ...
    private void SwapChainRenderTargetConstruct(DepthFormat depthFormat, ref Format dxgiFormat,
        ref SampleDescription multisampleDesc)
    {
