...
public partial class TextureCube
{
    ...
    private void PlatformGetData<T>(CubeMapFace cubeMapFace, int level, Rectangle rect, T[] data, int startIndex,
    ...
    private void PlatformSetData<T>(CubeMapFace face, int level, Rectangle rect, T[] data, int startIndex,
        int elementCount)
    {
        var elementSizeInByte = ReflectionHelpers.SizeOf<T>.Get();
