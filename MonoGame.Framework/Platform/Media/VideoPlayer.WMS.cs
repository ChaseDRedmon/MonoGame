...
public sealed partial class VideoPlayer : IDisposable
{
    ...
    private void PlatformInitialize()
    {
        ...
        AudioStreamVolumeGuid =
            Guid.Parse(
                ((GuidAttribute)typeof(AudioStreamVolume).GetCustomAttributes(typeof(GuidAttribute), false)[0])
                .Value);
    ...
    private Texture2D PlatformGetTexture()
    {
        ...
        if (_videoCache == null)
            _videoCache = new Texture2D(Game.Instance.GraphicsDevice, _currentVideo.Width, _currentVideo.Height,
                false, SurfaceFormat.Bgr32);
    ...
    private void PlatformPlay()
    {
        ...
        _videoCache = new Texture2D(Game.Instance.GraphicsDevice, _currentVideo.Width, _currentVideo.Height, false,
            SurfaceFormat.Bgr32);
    }
