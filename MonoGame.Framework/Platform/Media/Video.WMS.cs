...
public sealed partial class Video : IDisposable
{
    ...
    private void PlatformInitialize()
    {
        ...
        SharpDX.MediaFoundation.MediaSource mediaSource;
        {
            ...
            ObjectType otype;
            ComObject source =
                resolver.CreateObjectFromURL(FileName, SourceResolverFlags.MediaSource, null, out otype);
        ...
        for (var i = 0; i < presDesc.StreamDescriptorCount; i++)
        {
            ...
            if (selected)
            {
                ...
                if (majorType == MediaTypeGuids.Video)
                {
                    ...
                    _mediaType.Set(MediaTypeAttributeKeys.Subtype,
                        new Guid("00000016-0000-0010-8000-00AA00389B71"));
