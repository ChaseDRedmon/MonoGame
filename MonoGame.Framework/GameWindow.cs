...
public abstract class GameWindow
{
    ...
    internal bool IsTextInputHandled
    {
        get { return TextInput != null; }
    }
    ...
    {
        var window =
            new MonoGame.Framework.WinFormsGameWindow((MonoGame.Framework.WinFormsGamePlatform)game.Platform);
